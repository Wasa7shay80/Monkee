...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002575657379"))
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002677912680"))
...
try:
    ADMINS=[7040944963]
    for x in (os.environ.get("ADMINS", "7984604035").split()):
        ADMINS.append(int(x))
except ValueError:
